...
class WidgetExternalContentFactory extends aGenericWidgetFactory
{
    ...
    function completeWidget()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $this->startParams->id_metric = "ExternalContent";
                $this->startParams->name_w = str_replace("ToBeReplacedByFactory", "ExternalContent", $this->startParams->name_w); 
            }
        }
