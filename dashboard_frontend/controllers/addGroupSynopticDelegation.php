...
if(isset($_SESSION['loggedUsername'])) {
    ...
    if (checkVarType($dashboardId, "integer") === false) {
        eventLog("Returned the following ERROR in addGroupSynopticDelegation.php for id = ".$dashboardId.": ".$dashboardId." is not an integer as expected. Exit from script.");
        exit();
    }
    ...
    if($ds && $bind)
    {
        ...
        else
        {
			...
			if(isset($_SESSION['refreshToken']))
			{
				...
				$callBody = ["groupnameDelegated" => $newDelegated, "elementId" => $dashboardId, "elementType" => $synOwnElmtType ];
