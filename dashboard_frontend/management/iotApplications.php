                                ...
                                <div class="col-xs-12 mainContentCellCnt" style='background-color: rgba(138, 159, 168, 1)'>
                                    <div id="dashboardsListMenu" class="row">
                                        ...
                                        <div id="dashboardListsNewDashboard" class="col-xs-12 col-sm-6 col-md-2 dashboardsListMenuItem">
                                            ...
                                            <div class="dashboardsListMenuItemContent centerWithFlex col-xs-12">
                                                <button id="link_add_dashboard" data-toggle="modal" data-target="#modal-add-metric" type="button" class="btn btn-warning">Create new</button>
...
<script type='text/javascript'>
    $(document).ready(function () 
    {
        ...
        $('#iotAppsLink .mainMenuItemCnt').addClass("mainMenuItemCntActive");
        ...
        function myCardsWriter(rowIndex, record, columns, cellWriter)
        {
            ...
            if(title.length > 100)
            {
             ...
             var cardDiv = '<div data-uniqueid="' + record.id + '" data-title="' + title + '" data-url="' + record.url + '" data-icon="' + record.icon + '" data-privileges="' + record.privileges + '" class="dashboardsListCardDiv col-xs-12 col-sm-6 col-md-3">' + 
                ...
                success: function(data) 
                {
                    ...
                    $('#list_dashboard_cards').bind('dynatable:afterProcess', function(e, dynatable){
                        ...
                        $('#list_dashboard_cards div.dashboardsListCardDiv').each(function(i){
                            $(this).find('div.dashboardsListCardImgDiv').css("background-image", "url(../img/iotApplications/" + $(this).attr('data-uniqueid') + "/iotAppIcon.png)");
