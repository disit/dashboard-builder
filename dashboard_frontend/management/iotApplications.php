                ...
                <div class="col-xs-12 mainContentCellCnt">
                  ...
                  <div id="dashboardListsNewDashboard" class="iotAppsListMenuItem">
                    ...
                    <div class="iotAppsListMenuItemContent centerWithFlex col-xs-12">
                      ...
                      &nbsp;<button id="link_download_iotapp" onclick="location.href='../controllers/getIotApplications.php?download_all'" data-toggle="modal" type="button" class="btn btn-new-dash"><?= _("Download apps") ?></button>
                      <?php endif; ?>
                    </div>
                    <?php endif; ?>
                  </div>
        ...
        function myRowWriter(rowIndex, record, columns, cellWriter)
        {
            ...
            /*var cardDiv = '<div id="iotapp_'+record.id+'" data-uniqueid="' + record.id + '" data-title="' + title + '" data-url="' + record.url + '" data-type="' + record.type + '" data-icon="' + record.icon + '" data-iotapps="' + record.iotapps + '" data-privileges="' + record.privileges + '" data-created="' + record.created + '" data-username="' + record.username + '" data-edgetype="' + record.edgetype + '" class="iotAppsListCardDiv col-xs-12 col-sm-6 col-md-3">' + 
             ...
             var newRow = '<tr data-title="' + record.name + '" data-uniqueid="' + record.id + '" data-authorName="' + record.username + '" data-type="' + record.type + '" data-created="' + record.created + '">' +
                  ...
                  '<td class="' + cssClass + '"><button type="button" class="viewDashBtn managementBtn"><?= _("Management")?></button> <?php if( enableCreateIotApps() ) : ?><button type="button" class="viewDashBtn deleteBtn"><?= _("X")?></button><?php endif; ?></td>'+
                  '</tr>';
