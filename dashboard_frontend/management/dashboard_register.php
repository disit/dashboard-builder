...
<html>
    ...
    <body>
            ...
            <div id="panel-form" class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form id="form-register" name="form-register" class="form-signin" role="form" method="post" action="process-form.php" data-toggle="validator">
                        ...
                        <p>
                            <!--
                            <button id="button_annulla" name="register_cancel" class="btn btn-default btn-lg" type="button" onclick="location.href = 'index.php'">Annulla</button>
                            -->
                            <button id="button_annulla" name="register_cancel" class="btn btn-default btn-lg" type="button" onclick="location.href = 'dashboard_mng.php'">Annulla</button>
                            <button id="button_register_confirm" name="register_confirm" class="btn btn-primary btn-lg" type="submit">Conferma</button>
                        </p>
                    </form>
                </div>
            </div>    
        ...
        <script>
            ...
            console.log(admin);
                if (admin != 1){    
            $('#container-form').html("<h1>Accesso non autorizzato!</h1><p>Devi essere un utente amministratore per visualizzare questa pagina!<p>");
             }
             //
