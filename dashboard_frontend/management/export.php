...
// $id_Dashboard = 2410; // Municipality Dashboard (ENG)
$id_Dashboard = $_POST['dashboardId'];
...
$query1 = "SELECT * FROM Dashboard.Config_dashboard WHERE Config_dashboard.Id= $id_Dashboard";
...
if($result1) {
    ...
    $query4 = "SELECT * FROM Dashboard.Config_widget_dashboard WHERE id_dashboard = $id_Dashboard";
