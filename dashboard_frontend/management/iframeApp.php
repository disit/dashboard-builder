...
if ((!$_SESSION['isPublic'] && isset($_SESSION['newLayout']) && $_SESSION['newLayout'] === true) || ($_SESSION['isPublic'] && $_COOKIE['layout'] == "new_layout") || (!$_SESSION['isPublic'] && $_COOKIE['layout'] == 'new_layout')) {
                ...
                <div class="col-xs-12 col-md-10" id="mainCnt">
                  <!-- MOBILE MENU -->
                    ...
                    <div class="row header-container">
                        ...
                        <div id="headerTitleCnt"></div>
                        <div class="user-menu-container">
                          <?php include "loginPanel.php" ?>
                        </div>
                        <div class="col-lg-2 hidden-md hidden-lg" id="headerMenuCnt">
                          <?php include "mobMainMenu.php" ?>
                        </div>
                    </div>
                    <div class="row">
                        <div id="iframePagemainContentCnt">
...
<?php } else {
    include('../s4c-legacy-management/iframeApp.php');
}
?>