...
<?php endif;?>
<div id="modal_tab_wiz" class="tab-content modal_wrapper_wizard">
...
<script type='text/javascript'>
    $(document).ready(function ()
    {
        ...
        if (window.location.href.includes("inspectorOS.php")) {
...
<?php } else {
    include('../s4c-legacy-management/addWidgetWizardInclusionCodeOS.php');
}
?>