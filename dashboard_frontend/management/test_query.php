...
if (isset($_GET['urlDS'])) {
    $hostname = $_GET['urlDS']; //url di datasources    
} else {
...
if (isset($_GET['tipo_acquisizione'])) {
    $modality = $_GET['tipo_acquisizione']; //modalità acquisizione
} else {
...
if (isset($_GET['usernameDS'])) {
    $username = $_GET['usernameDS']; //username di datasources
} else {
    $username = "";
}
if (isset($_GET['passwordDS'])) {
    $password = $_GET['passwordDS']; //password di datasources  
} else {
    $password = "";
}

if (isset($_GET['databaseDS'])) {
    $database = $_GET['databaseDS'];
} else {
...
if (isset($_GET['databaseTypeDS'])) {
    $dataType = $_GET['databaseTypeDS']; //datatype  
} else {
