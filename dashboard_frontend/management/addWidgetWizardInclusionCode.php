...
<div class="tab-content modal_wrapper_wizard">
    ...
    <div id="dataAndWidgets" class="tab-pane fade in">
                    ...
                    <table id="widgetWizardTable" class="addWidgetWizardTable table table-striped dt-responsive nowrap" style="margin-left:-15px">
                        <thead class="widgetWizardColTitle">
                            ...
                            <tr>  
                                ...
                                <th class="widgetWizardTitleCell" data-cellTitle="InstanceUri"><?= _("Instance URI")?></th>
                                <th class="widgetWizardTitleCell" data-cellTitle="DeviceModel"><?= _("Device/Model")?></th>
        ...
        <!--    <div class="row hideIfActuatorNew hideFullyCustom" style="padding-left: 15px; padding-right: 15px;">    -->
                <div class="row hideIfActuatorNew hideFullyCustom">
                <!-- Comandi tabella -->
...
<script type='text/javascript'>
    ...
    //    dashTitleEscaped = dashTitle.replace(/\'/g, "%27");
        ...
        if ("<?= $_SESSION['loggedRole'] ?>" == "RootAdmin") {
            invisibleCols = [3, 4, 5, 15, 16, 17, 19, 22, 23, 24, 25, 26, 27];
        } else {
        ...
        $('#togBtn').click(function(){
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    //    populateSelectMenus("nature", data.nature.join('|'), natureSelect, "#natureColumnFilter", 1, false, false);
                ...
                else
                {
                    ...
                    if(validityConditions.widgetTypeSelected)
                    {
                        if($('.addWidgetWizardIconClickClass[data-selected="true"]').attr("data-widgetcategory") === "dataViewer")
                        {
                            ...
                            if(validityConditions.atLeastOneRowSelected)
                            {
                               /* if ($('.addWidgetWizardIconClickClass[data-selected="true"]').attr("data-mainwidget") == "widgetBarSeries" && ObjectSize(wizardSelectedRowsObj) > 1) {
                                 ...
                                 //   } else {
                                        ...
                                        updateBarSeriesWidgetSelectedRows(wizardSelectedRowsObj, Object.keys(wizardSelectedRowsObj)[0]);
                                 //   }
                                } else {*/
                                    $('#addWidgetWizardNextBtn').removeClass('disabled');
                                    $('#cTab a').attr("data-toggle", "tab");
        ...
        $('#actuatorTargetInstance').change(function()
        {
            if($(this).val() === 'new')
            {
                ...
                if(!location.href.includes("dashboard_configdash.php")&&($('.modalAddDashboardWizardChoiceCnt[data-selected="true"]').attr("data-templatename") === 'iotDevicesBroker'))
                {
    ...
    //    $('#actuatorEntityName').on('input', checkActuatorFieldsLength);
       ...
       //     widgetWizardSelectedSingleRow = null;
        ...
        widgetWizardSelectedRowsTable = $('#widgetWizardSelectedRowsTable').DataTable({
          ...
          /*  colReorder: {
            ...
            "createdRow": function (row, data, index) {
                ...
                $(row).attr('data-widgetCompatible', data[16]);
        ...
        {
            if ($(this).attr('data-high_level_type') != "Dashboard-IOT App" || "<?= $_SESSION['loggedRole'] ?>" == "RootAdmin") {
        ...
        else//Caso dashboards.php
        {
            ...
            $('.modalAddDashboardWizardChoiceCnt').click(function(i)
            {
                ...
                else
                {
                    ...
                    widgetWizardTable.column(3).visible(true);
                    widgetWizardTable.column(4).visible(true);
                    widgetWizardTable.column(10).visible(true);  // data-type
                    widgetWizardTable.column(7).visible(true);
                    widgetWizardTable.column(8).visible(true);
                    widgetWizardTable.column(9).visible(true);
