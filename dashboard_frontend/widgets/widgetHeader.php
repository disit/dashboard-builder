...
<script type='text/javascript'>
    $(document).ready(function()
    {
     //   console.log("Widget Header of : " + "<?= str_replace('.', '_', str_replace('-', '_', $_REQUEST['name_w'])) ?>");
        ...
        if ("<?= str_replace('.', '_', str_replace('-', '_', $_REQUEST['type_w'])) ?>" == "widgetTimeTrend" || "<?= str_replace('.', '_', str_replace('-', '_', $_REQUEST['type_w'])) ?>" == "widgetCurvedLineSeries" || "<?= str_replace('.', '_', str_replace('-', '_', $_REQUEST['type_w'])) ?>" == "widgetTimeTrendCompare") {
