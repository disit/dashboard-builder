...
<script type='text/javascript'>
	...
	var showHeader = null;
        var widgetProperties, metricData, metricType, series, styleParameters, legendHeight, chartType, highchartsChartType, 
            ...
            widgetHeight, xAxisDataset, lineWidth, xAxisTitle, metricName, widgetTitle, countdownRef, widgetParameters, thresholdsJson, infoJson = null;
                            ...
                            tooltip: {
                                ...
                                pointFormatter: function()
                                {
                                    ...
                                    if(rangeOnThisField)
                                    {
                                        if((desc !== null)&&(desc !== ''))
                                        {
                                            return '<span style="color:' + this.color + '">\u25CF</span><b> ' + this.series.name_w + '</b>: <b>' + this.y + '</b><br/>' + 
