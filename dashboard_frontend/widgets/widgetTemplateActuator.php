...
<script type='text/javascript'>
    ...
    $(document).ready(function <?= $_GET['name'] ?>(firstLoad, metricNameFromDriver, widgetTitleFromDriver, widgetHeaderColorFromDriver, widgetHeaderFontColorFromDriver, fromGisExternalContent, fromGisExternalContentServiceUri, fromGisExternalContentField, fromGisExternalContentRange, /*randomSingleGeoJsonIndex,*/ fromGisMarker, fromGisMapRef) 
    {
        ...
        //Reperimento da DB (mediante passaggio lato server) di tutti i parametri per instanziare questo widget
        widgetProperties = getWidgetProperties(widgetName);
        
        if((widgetProperties !== null) && (widgetProperties !== 'undefined'))
        {
            //Inizio eventuale codice ad hoc basato sulle proprietà del widget
            styleParameters = widgetProperties.param.styleParameters;
            ...
            //Andrà sostituita con una chiamata di reperimento dei dati caratteristici dell'oggetto da pilotare.
            ...
            if(metricData !== null)
            {
                if(metricData.data[0] !== 'undefined')
                {
                    if(metricData.data.length > 0)
                    {
                        ...
                        //QUI ANDRA' INSERITO TUTTO IL CODICE DEL WIDGET
...
<div class="widget" id="<?= $_GET['name'] ?>_div">
    <div class='ui-widget-content'>
        ...
        <div id="<?= $_GET['name'] ?>_content" class="content">
            ...
            <!-- Qui ci metti il markup HTML specifico per il tuo widget --> 
