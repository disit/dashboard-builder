    ...
    var Qolor = function() {
        ...
        return r.parse = function(t) {
            ...
            fromHSL: function(e, n, r) {
                if (0 === n) return this.r = this.g = this.b = r, this;
...
//            this.isDisabled || (this.prevRotation += (e.clientX - this.prevX) * (360 / this.window.innerWidth), this.prevTilt -= (e.clientY - this.prevY) * (360 / this.window.innerHeight), APP.setRotation(this.prevRotation), APP.setTilt(this.prevTilt))
        ...
        onTouchEndDocument(e) {
            ...
            if (0 === e.touches.length)
                if (this.buttons = 0, this.isMove) this.emit("pointerup", {
                    buttons: 1
                });
                else {
                    const t = getEventXY(e);
    ...
    const SHADOW_MAP_MAX_BUILDING_HEIGHT = 100,
        ...
        DEFAULT_ICON = '<svg height="600" width="600"><path d="M0 0 L0 500 L250 500 L300 600 L350 500 L600 500 L600 0 Z" /></svg>';
    class Request {
        static load(e, t) {
    ...
    class FeatureCollection extends Collection {
        constructor(...e) {
            super(...e), this.tintCallback = (() => {}), this.zScaleCallback = (() => {})
        }
        setTintCallback(e) {
    ...
    View.Picking = class {
        ...
        getTarget(e, t, n) {
            requestAnimationFrame(() => {
                ...
                if (this.framebuffer.disable(), !s) return void n();
                const l = s[0] - 1,
                    u = (s[1] | s[2] << 8) - 1,
                    h = {};
