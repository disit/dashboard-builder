!function () {
    var Qolor = function () {
        ...
        function n(e, t) {
            if (void 0 !== e)
                return Math.min(t, Math.max(0, e || 0))
        }
        var r = function (e, t, r, i) {
            this.r = n(e, 1), this.g = n(t, 1), this.b = n(r, 1), this.a = n(i, 1) || 1
        };
        return r.parse = function (t) {
            if ("string" == typeof t) {
                var n;
                if (t = t.toLowerCase(), n = (t = e[t] || t).match(/^#?(\w{2})(\w{2})(\w{2})$/))
                    return new r(parseInt(n[1], 16) / 255, parseInt(n[2], 16) / 255, parseInt(n[3], 16) / 255);
                if (n = t.match(/^#?(\w)(\w)(\w)$/))
                    return new r(parseInt(n[1] + n[1], 16) / 255, parseInt(n[2] + n[2], 16) / 255, parseInt(n[3] + n[3], 16) / 255);
                if (n = t.match(/rgba?\((\d+)\D+(\d+)\D+(\d+)(\D+([\d.]+))?\)/))
                    return new r(parseFloat(n[1]) / 255, parseFloat(n[2]) / 255, parseFloat(n[3]) / 255, n[4] ? parseFloat(n[5]) : 1)
            }
            return new r
            ...
            fromHSL: function (e, n, r) {
                if (0 === n)
                    return this.r = this.g = this.b = r, this;
                var i = r < .5 ? r * (1 + n) : r + n - r * n,
                        o = 2 * r - i;
                return e /= 360, this.r = t(o, i, e + 1 / 3), this.g = t(o, i, e), this.b = t(o, i, e - 1 / 3), this
            },
            toString: function () {
                if (this.isValid())
    ...
    var earcut = function () {
        function e(e, i, o) {
            ...
            if (x && (v = function (e, r, i, o) {
                ...
                for (a = 0, s = r.length; a < s; a++)
                    h = r[a] * o, f = a < s - 1 ? r[a + 1] * o : e.length, (d = t(e, h, f, o, !1)) === d.next && (d.steiner = !0), m.push(c(d));
                ...
                a = h = e[0], s = f = e[1];
                for (var w = o; w < g; w += o)
                    (d = e[w]) < a && (a = d), (m = e[w + 1]) < s && (s = m), d > h && (h = d), m > f && (f = m);
                p = Math.max(h - a, f - s)
            }
        ...
        function n(e, t) {
            ...
            var n, r = e;
            do {
                if (n = !1, r.steiner || !p(r, r.next) && 0 !== m(r.prev, r, r.next))
                    r = r.next;
                else {
                    if (w(r), (r = t = r.prev) === r.next)
                        return null;
                    n = !0
                }
            } while (n || r !== t);
            ...
            if (e) {
                                ...
                                do {
                                    for (n = e, e = null, o = null, a = 0; n; ) {
                                        for (a++, r = n, s = 0, t = 0; t < u && (s++, r = r.nextZ); t++)
                                            ;
                                        for (l = u; s > 0 || l > 0 && r; )
                                            0 === s ? (i = r, r = r.nextZ, l--) : 0 !== l && r ? n.z <= r.z ? (i = n, n = n.nextZ, s--) : (i = r, r = r.nextZ, l--) : (i = n, n = n.nextZ, s--), o ? o.nextZ = i : e = i, i.prevZ = o, o = i;
                                        n = r
                                    }
                                    o.nextZ = null, u *= 2
                                } while (a > 1)
                ...
                for (var m, p, x = e; e.prev !== e.next; )
                    if (m = e.prev, p = e.next, f ? o(e, u, c, f) : i(e))
                        t.push(m.i / l), t.push(e.i / l), t.push(p.i / l), w(e), e = p.next, x = p.next;
                    else if ((e = p) === x) {
        ...
        function i(e) {
            ...
            for (var i = e.next.next; i !== e.prev; ) {
                if (f(t.x, t.y, n.x, n.y, r.x, r.y, i.x, i.y) && m(i.prev, i, i.next) >= 0)
                    return !1;
                i = i.next
            }
            return !0
        ...
        function o(e, t, n, r) {
            ...
            for (var s = i.x < o.x ? i.x < a.x ? i.x : a.x : o.x < a.x ? o.x : a.x, l = i.y < o.y ? i.y < a.y ? i.y : a.y : o.y < a.y ? o.y : a.y, u = i.x > o.x ? i.x > a.x ? i.x : a.x : o.x > a.x ? o.x : a.x, c = i.y > o.y ? i.y > a.y ? i.y : a.y : o.y > a.y ? o.y : a.y, d = h(s, l, t, n, r), p = h(u, c, t, n, r), x = e.nextZ; x && x.z <= p; ) {
                if (x !== e.prev && x !== e.next && f(i.x, i.y, o.x, o.y, a.x, a.y, x.x, x.y) && m(x.prev, x, x.next) >= 0)
                    return !1;
                x = x.nextZ
            }
        ...
        function u(e, t) {
            if (t = function (e, t) {
                ...
                r = n.next;
                for (; r !== u; )
                    i >= r.x && r.x >= h && f(o < c ? i : a, o, h, c, o < c ? a : i, o, r.x, r.y) && ((l = Math.abs(o - r.y) / (i - r.x)) < d || l === d && r.x > n.x) && g(r, e) && (n = r, d = l), r = r.next;
                return n
            }(e, t)) {
                var r = v(t, e);
                n(r, r.next)
        ...
        function d(e, t) {
            return e.next.i !== t.i && e.prev.i !== t.i && !function (e, t) {
                var n = e;
                do {
                    if (n.i !== e.i && n.next.i !== e.i && n.i !== t.i && n.next.i !== t.i && x(n, n.next, e, t))
                        return !0;
                    n = n.next
                } while (n !== e);
                return !1
    ...
    GLX.Buffer = class {
        ...
        constructor(e) {
            if (this.name = e.source.name || "", this.id = GL.createProgram(), this.compile(GL.VERTEX_SHADER, e.source.vs), this.compile(GL.FRAGMENT_SHADER, e.source.fs), GL.linkProgram(this.id), !GL.getProgramParameter(this.id, GL.LINK_STATUS))
        ...
        locateAttribute(e) {
            ...
            if (t < 0)
                throw new Error(`unable to locate attribute "${e}" in shader "${this.name}"`);
            this.attributes[e] = t
        }
        locateUniform(e) {
            const t = GL.getUniformLocation(this.id, e);
            if (!t)
                throw new Error(`unable to locate uniform "${e}" in shader "${this.name}"`);
            this.uniforms[e] = t
        }
        compile(e, t) {
            const n = GL.createShader(e);
            if (GL.shaderSource(n, t), GL.compileShader(n), !GL.getShaderParameter(n, GL.COMPILE_STATUS))
        ...
        setBuffer(e, t) {
            if (void 0 === this.attributes[e])
                throw new Error(`attempt to bind buffer to invalid attribute "${e}" in shader "${this.name}"`);
            t.enable(), GL.vertexAttribPointer(this.attributes[e], t.itemSize, GL.FLOAT, !1, 0, 0)
        }
        setParam(e, t, n) {
            if (void 0 === this.uniforms[e])
                throw new Error(`attempt to bind to invalid uniform "${e}" in shader "${this.name}"`);
        ...
        load(e, t) {
            ...
            // --------------------- CORTI - edit per convertire XYZ in WMS --------------------------
            if(e.includes('service=WMS')){                
                ...
                function coordToTileXY(lat, lng, zoom){
                    let n = Math.pow(2, zoom);
                    xtile = n * ((lng + 180) / 360);
                    ytile = n * (1 - (Math.log(Math.tan(deg2rad(lat)) + sec(deg2rad(lat))) / Math.PI)) / 2;
                    return { x: parseInt(xtile), y: parseInt(ytile) };
                }
                ...
                function getBoundingBoxFromUTMCoord(x, y, z){
                    let nt = tileToLat(y,z);
                    let es = tileToLng(x,z);
                    let st = tileToLat(y+1,z);
                    let wt = tileToLng(x+1,z);
                    return { n: nt, e: es, s: st, w: wt };
                }
                
                // coordinate UTM
                let firstPart = e.substr(0,e.lastIndexOf('/'));
                let secondPart = firstPart.substr(0,firstPart.lastIndexOf('/'));
                let thirdPart = secondPart.substr(0,secondPart.lastIndexOf('/'));
                let y = e.replace(firstPart,'').replace('/','');
                let x = firstPart.replace(secondPart,'').replace('/','');
                let z = secondPart.replace(thirdPart,'').replace('/','');

//                let UTMpos = coordToTileXY(map.default3DMapRef.getPosition().latitude, map.default3DMapRef.getPosition().longitude, map.default3DMapRef.getZoom());
                let bbox = getBoundingBoxFromUTMCoord(parseInt(x), parseInt(y), parseInt(z));
                e = thirdPart + '&bbox=' + bbox.e + ',' + bbox.s + ',' + bbox.w + ',' + bbox.n;
            }
            // ------------------------------------------------------------------------------------------
    ...
    class WorkerPool {
        constructor(e, t) {
            this.items = [];
            for (let n = 0; n < t; n++)
                this.items[n] = new WorkerWrapper(e)
        }
        get(e) {
    ...
    class IconCollection extends Collection {
        get(e, t) {
            for (let n = 0; n < this.items.length; n++)
                if (this.items[n].url === e)
                    return void t(null, this.items[n]);
            new Icon(e).load(t)
        }
    }
    class Icon {
    ...
    class Marker{
        constructor(e,t=null,n={}){
            ...
            n.anchor;
            const r=n.scale||1;
            this.color=Qolor.parse(n.color||Marker.defaultColor).toArray(),this.metersPerLon=METERS_PER_DEGREE_LATITUDE*Math.cos(e.latitude/180*Math.PI),this.longitude=e.longitude,this.latitude=e.latitude,this.altitude=e.altitude||0,this.matrix=new GLX.Matrix,this.matrix.scale(r,r,r),n.url?APP.icons.get(n.url,(e,t)=>{e||(this.icon=t,APP.markers.add(this))}):APP.icons.get(Icon.defaultURL,(e,t)=>{e||(this.icon=t,APP.markers.add(this))})
        }
        getMatrix(){
    ...
    class OSMBuildings {
        constructor(e = {}) {
            try {
                APP = this, e.style && (e.style.color || e.style.wallColor) && (DEFAULT_COLOR = Qolor.parse(e.style.color || e.style.wallColor).toArray()), this.view = new View, this.view.backgroundColor = Qolor.parse(e.backgroundColor || BACKGROUND_COLOR).toArray(), this.view.fogColor = Qolor.parse(e.fogColor || FOG_COLOR).toArray(), this.attribution = e.attribution || OSMBuildings.ATTRIBUTION, this.minZoom = Math.max(parseFloat(e.minZoom || MIN_ZOOM), MIN_ZOOM), this.maxZoom = Math.min(parseFloat(e.maxZoom || MAX_ZOOM), MAX_ZOOM), this.maxZoom < this.minZoom && (this.minZoom = MIN_ZOOM, this.maxZoom = MAX_ZOOM), this.bounds = e.bounds, this.position = e.position || {
                    latitude: 52.52,
                    longitude: 13.41
                }, this.zoom = e.zoom || this.minZoom + (this.maxZoom - this.minZoom) / 2, this.rotation = e.rotation || 0, this.tilt = e.tilt || 0, e.disabled && this.setDisabled(!0);
                const t = Math.min(window.navigator.hardwareConcurrency, 4),
                        n = new Blob([workers.feature], {
                            type: "application/javascript"
                        });
                this.workers = new WorkerPool(URL.createObjectURL(n), 4 * t);
                let r = e.container;
                "string" == typeof r && (r = document.getElementById(e.container)), this.container = document.createElement("DIV"), this.container.className = "osmb", 0 === r.offsetHeight && (r.style.height = "100%", console.warn("Container height should be set. Now defaults to 100%.")), r.appendChild(this.container), this.canvas = document.createElement("CANVAS"), this.canvas.className = "osmb-viewport";
                this.canvas.width = this.width = 1 * r.offsetWidth, this.canvas.height = this.height = 1 * r.offsetHeight, this.container.appendChild(this.canvas), this.glx = new GLX(this.canvas, e.fastMode), GL = this.glx.GL, this.features = new FeatureCollection, this.icons = new IconCollection, this.markers = new Collection, this.events = new Events(this.canvas), this._getStateFromUrl(), e.state && (this._setStateToUrl(), this.events.on("change", e => {
                    this._setStateToUrl()
        ...
        destroy() {
            this.view.destroy(), this.events.destroy(), this.glx.destroy(), this.canvas.parentNode.removeChild(this.canvas), this.features.destroy(), this.markers.destroy(), this.container.innerHTML = ""
        }
    }
    ...
    class Events {
        constructor(e) {
            this.window = top || window, this.listeners = {}, this.isDisabled = !1, this.prevX = 0, this.prevY = 0, this.startZoom = 0, this.prevRotation = 0, this.prevTilt = 0, this.startDist = 0, this.startAngle = 0, this.buttons = 0, this.addAllListeners(this.window, e)
        }
        addAllListeners(e, t) {
            const n = e.document;
            let r;
            "ontouchstart" in e ? (addListener(t, "touchstart", e => {
                this.onTouchStart(e)
            }), addListener(n, "touchmove", e => {
                this.onTouchMoveDocument(e)
            }), addListener(t, "touchmove", e => {
                this.onTouchMove(e)
            }), addListener(n, "touchend", e => {
                this.onTouchEndDocument(e)
            }), addListener(n, "gesturechange", e => {
                this.onGestureChangeDocument(e)
            })) : (addListener(t, "mousedown", e => {
                this.onMouseDown(e)
            }), addListener(n, "mousemove", e => {
                this.onMouseMoveDocument(e)
            }), addListener(t, "mousemove", e => {
                this.onMouseMove(e)
            }), addListener(n, "mouseup", e => {
                this.onMouseUpDocument(e)
            }), addListener(t, "mouseup", e => {
                this.onMouseUp(e)
            }), addListener(t, "dblclick", e => {
                this.onDoubleClick(e)
            }), addListener(t, "mousewheel", e => {
                this.onMouseWheel(e)
            }), addListener(t, "DOMMouseScroll", e => {
                this.onMouseWheel(e)
//            }), addListener(t, "contextmenu", e => {
//                this.onContextMenu(e)
            })), addListener(window, "resize", e => {
                r || (r = setTimeout(() => {
                    r = null, APP.setSize(APP.container.offsetWidth, APP.container.offsetHeight)
                }, 250))
            })
        }
        cancelEvent(e) {
        ...
        onDoubleClick(e) {
            APP.view.speedUp(), this.cancelEvent(e), this.emit("doubleclick", {
                ...getEventXY(e),
                buttons: e.buttons
            }), this.isDisabled || APP.setZoom(APP.zoom + 1, e)
        }
        onMouseDown(e) {
            APP.view.speedUp(), this.cancelEvent(e), this.startZoom = APP.zoom, this.prevRotation = APP.rotation, this.prevTilt = APP.tilt, this.prevX = e.clientX, this.prevY = e.clientY, this.isMove = !1, 1 === e.buttons && e.altKey || 2 === e.buttons ? this.buttons = 2 : 1 === e.buttons && (this.buttons = 1), this.emit("pointerdown", {
                ...getEventXY(e),
                buttons: e.buttons
            })
        }
        onMouseMoveDocument(e) {
            1 === this.buttons ? (APP.view.speedUp(), this.moveMap(e), this.isMove = !0) : 2 === this.buttons && (APP.view.speedUp(), this.rotateMap(e), this.isMove = !0), this.prevX = e.clientX, this.prevY = e.clientY
        }
        onMouseMove(e) {
            this.emit("pointermove", getEventXY(e))
        }
        onMouseUpDocument(e) {
            this.buttons && (1 === this.buttons ? this.moveMap(e) : 2 === this.buttons && this.rotateMap(e), this.buttons = 0)
        }
        onMouseUp(e) {
            if (this.isMove)
                this.emit("pointerup", {
                ...
                APP.view.Picking.getTarget(t.x, t.y, t => {
                    this.emit("pointerup", {
                        buttons: e.buttons,
                        ...t
                    })
        ...
        rotateMap(e) {
//            this.isDisabled || (this.prevRotation += (e.clientX - this.prevX) * (360 / this.window.innerWidth), this.prevTilt -= (e.clientY - this.prevY) * (360 / this.window.innerHeight), APP.setRotation(this.prevRotation), APP.setTilt(this.prevTilt))
        }
        emitGestureChange(e) {
            const t = e.touches[0],
                    n = e.touches[1],
        ...
        onTouchStart(e) {
            APP.view.speedUp(), this.cancelEvent(e), this.buttons = 1, this.isMove = !1;
            const t = e.touches[0];
            if (2 === e.touches.length && !("ongesturechange" in this.window)) {
                const n = e.touches[1],
                        r = t.clientX - n.clientX,
                        i = t.clientY - n.clientY;
        ...
        onTouchMoveDocument(e) {
            ...
            APP.view.speedUp();
            const t = e.touches[0];
            e.touches.length > 1 ? (APP.setTilt(this.prevTilt + (this.prevY - t.clientY) * (360 / this.window.innerHeight)), this.prevTilt = APP.tilt, "ongesturechange" in this.window || this.emitGestureChange(e), this.isMove = !0) : (this.moveMap(t), this.isMove = !0), this.prevX = t.clientX, this.prevY = t.clientY
        }
        onTouchMove(e) {
            1 === e.touches.length && this.emit("pointermove", {
                ...getEventXY(e.touches[0]),
                buttons: 1
            })
        }
        onTouchEndDocument(e) {
            ...
            if (0 === e.touches.length)
                ...
                1 === e.touches.length && (this.prevX = t.clientX, this.prevY = t.clientY)
        }
        onGestureChangeDocument(e) {
            this.buttons && (APP.view.speedUp(), this.cancelEvent(e), this.isDisabled || (APP.setZoom(this.startZoom + (e.scale - 1)), APP.setRotation(this.prevRotation - e.rotation)), this.emit("gesture", e))
        }
        on(e, t) {
    ...
    class Grid {
        ...
        update() {
            ...
            }), this.queue.sort((e, t) => t.distance - e.distance), setTimeout(() => {
                this.update()
            }, 100)
        }
        queueNext() {
            if (!this.queue.length)
                return void setTimeout(this.queueNext.bind(this), 200);
        ...
        destroy() {
            for (let e in this.tiles)
                this.tiles[e].destroy();
            this.tiles = {}, this.queue = []
        }
    }
    class Tile {
        constructor(e, t, n) {
    ...
    class Feature {
        constructor(e, t, n = {}, r = function() {}) {
            this.type = e, this.options = n, this.callback = r, this.id = n.id, this.color = n.color, this.matrix = new GLX.Matrix, this.scale(n.scale || 1), this.rotate(n.rotation || 0), this.minZoom = Math.max(parseFloat(n.minZoom || MIN_ZOOM), APP.minZoom), this.maxZoom = Math.min(parseFloat(n.maxZoom || MAX_ZOOM), APP.maxZoom), this.maxZoom < this.minZoom && (this.minZoom = MIN_ZOOM, this.maxZoom = MAX_ZOOM), this.load(t)
        }
        load(e) {
            APP.workers.get(t => {
                t.onMessage(e => {
                    if ("error" === e)
                        return this.callback(), void t.free();
        ...
        getMatrix() {
            return this.matrix.translateTo((this.longitude - APP.position.longitude) * this.metersPerLon, (APP.position.latitude - this.latitude) * METERS_PER_DEGREE_LATITUDE, 0), this.matrix
        }
        getFade() {
            if (this.fade >= 1)
                return 1;
    ...
    function rasterTriangle(e, t, n) {
        const r = [e, t, n];
        if (r.sort((e, t) => e[1] < t[1]), e = r[0], t = r[1], n = r[2], e[1] == t[1])
            return rasterFlatTriangle(e, t, n);
        if (t[1] == n[1])
            return rasterFlatTriangle(t, n, e);
        ...
        renderFrame() {
            APP.zoom >= APP.minZoom && APP.zoom <= APP.maxZoom && requestAnimationFrame(() => {
                ...
                if (this.shadowsEnabled) {
                    ...
                    this.Buildings.render(), this.Markers.render(), GL.enable(GL.BLEND), GL.blendFuncSeparate(GL.ONE_MINUS_DST_ALPHA, GL.DST_ALPHA, GL.ONE, GL.ONE), GL.disable(GL.DEPTH_TEST), this.Horizon.render(), GL.disable(GL.BLEND), GL.enable(GL.DEPTH_TEST), this.Basemap.render();
                try{
    ...
    View.Picking = class {
        ...
        renderFeatures() {
            ...
            return APP.features.forEach(n => {
                if (APP.zoom < n.minZoom || APP.zoom > n.maxZoom)
                    return;
                let r = n.getMatrix();
        ...
        getTarget(e, t, n) {
            requestAnimationFrame(() => {
                ...
                const r = this.renderFeatures(),
                        i = this.renderMarkers(r.length);
                GL.viewport(0, 0, APP.width, APP.height);
                const o = e / APP.width * this.size[0] << 0,
                        a = t / APP.height * this.size[1] << 0,
                        s = this.framebuffer.getPixel(o, this.size[1] - 1 - a);
                if (this.framebuffer.disable(), !s)
                    return void n();
                const l = s[0] - 1,
                        u = (s[1] | s[2] << 8) - 1,
                        h = {};
                h.features = this.findFeatures(r, l, u), h.marker = i[u] && i[u].data, n(h)
            })
        }
        destroy() {
        ...
        render() {
            ...
            for (let t in e.visibleTiles) {
                ...
                for (let t = 0; t < 4; t++)
                    e.tiles[o[t]] && e.tiles[o[t]].isReady && this.renderTile(e.tiles[o[t]])
            }
            t.disable()
        }
        renderTile(e) {
        ...
        updateGeometry(e) {
            ...
            if (equal3(t, this.v1) && equal3(n, this.v2) && equal3(r, this.v3) && equal3(i, this.v4))
                return;
