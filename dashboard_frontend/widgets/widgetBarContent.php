    ...
    $(document).ready(function <?= $_GET['name'] ?>(firstLoad) 
    {
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                var sizeColsWidget = parseInt(msg.param.size_columns);
                var rangeMin = null;
                var rangeMax = null;
...
<div class="widget" id="<?= $_GET['name'] ?>_div">
    <div class='ui-widget-content'>
        ...
        <div class="icons-modify-widget"><a class="icon-cfg-widget" href="#"><span class="glyphicon glyphicon-cog glyphicon-modify-widget" aria-hidden="true"></span></a><a class="icon-remove-widget" href="#"><span class="glyphicon glyphicon-remove glyphicon-modify-widget" aria-hidden="true"></span></a></div><div id="countdown_<?= $_GET['name'] ?>" class="countdown"></div>
        ...
        <div id="<?= $_GET['name'] ?>_content" class="content bar_content"></div>
    </div>	
</div> 