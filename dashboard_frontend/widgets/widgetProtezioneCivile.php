...
<script type='text/javascript'>
    ...
    $(document).ready(function <?= $_REQUEST['name_w'] ?>(firstLoad)  
    {
        ...
        if (checkWidgetNameInDashboard($link, $_REQUEST['name_w'], $_REQUEST['id_dashboard']) === false) {
            eventLog("Returned the following ERROR in widgetProtezioneCivile.php for the widget ".escapeForHTML($_REQUEST['name_w'])." is not instantiated or allowed in this dashboard.");
            exit();
        }
        ?>
        ...
        $("#<?= $_REQUEST['name_w'] ?>_logo").css("background-color", '<?= escapeForJS($_REQUEST['frame_color_w']) ?>');
