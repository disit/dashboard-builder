        ...
        class i {
                ...
                if (s === this.getModuleFromNodeId(t)) {
                    ...
                    if (!1 === l) {
                        if (this.drawflow.drawflow[s].data[e].outputs[n].connections.push({
                            ...
                            r.classList.add("main-path"), r.setAttributeNS(null, "d", ""), a.classList.add("connection"), a.classList.add("node_in_node-" + t), a.classList.add("node_out_node-" + e), a.classList.add(n), a.classList.add(i), r.setAttributeNS(null, "id", "node_" + parseInt(e) + "_output_" + parseInt(t) + "_conn_" + n), a.appendChild(r), this.precanvas.appendChild(a), this.updateConnectionNodes("node-" + e), this.updateConnectionNodes("node-" + t)
                        }
            ...
            addNodeInput(e) {
                ...
                if (this.module === t) {
                    ...
                    t.id = e + "_output_" + (i + 1);
                    this.container.querySelector("#node-" + e + " .inputs").appendChild(t);
            ...
            addNodeOutput(e) {
                ...
                if (this.module === t) {
                    ...
                    t.id = "node_" + e + "_output_" + (i + 1);
                    this.container.querySelector("#node-" + e + " .outputs").appendChild(t);
                    this.updateConnectionNodes("node-" + e);
                }
