...
//
// Assuming that `that._map` is your Leaflet map

// Create a new div element
/*
var newDiv = document.createElement('div');
newDiv.className = 'leaflet-bottom leaflet-center'; // Set the class
newDiv.innerHTML = '<div class="leaflet-control-attribution leaflet-control">New street to add</div>';
var mapContainer = that._map.getContainer().querySelector('.leaflet-control-container');
...
that._map.on('click', function (e) {
    ...
    //
    var popupContent = '<div id="scenario-div"><div>You have added a new street in the map. Are you sure di you want confirm?</div><br /><div><input type="button" id="add_line" value="Confirm" style="margin: 2%"> <button id="cancel_line" type="button" style="margin: 2%">Cancel</button></div></div>';
    var popup = L.popup()
