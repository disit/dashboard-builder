...
echo("*** Starting IOT_Sensor_FeedDashboardWizard208 SCRIPT on LonatoDelGarda KB at: " . $start_time_ok . "\n");
...
$queryIotSensor = $kbHostUrlLonatoDelGarda . ":8890/sparql?default-graph-uri=&query=" . urlencode($queryIotSensorDecoded) . "&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on";
...
echo("End IOT_Sensor_FeedDashboardWizard208 SCRIPT on LonatoDelGarda KB at: " . $end_time_ok);
