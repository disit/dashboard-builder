...
$queryIotSensorDecoded = "select distinct ?s ?n ?a ?dt ?u ?vt ?serviceType (coalesce(?org,\"DISIT\") as ?organization) ?brokerName ?lat ?lon {" .
...
foreach ($resArray['results']['bindings'] as $key => $val) {
 ...
 //   $unique_name_id = 'DISIT:orionUNIFI:angelo-prova636';
