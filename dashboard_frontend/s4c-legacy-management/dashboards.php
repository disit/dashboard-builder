                                        ...
                                        <?php if ($_SESSION['loggedRole'] === 'RootAdmin') { ?>
                                            ...
                                            <?php if (!$_SESSION['isPublic']) : ?>
                                                <div id="dashboardListsNewDashboard" class="col-xs-12 col-sm-12 col-md-3 dashboardsListMenuItem">
                                                    ...
                                                    <div class="dashboardsListMenuItemContent centerWithFlex col-xs-4">
                                                        <button id="importButton" class="btn btn-warning">Import Dashboard</button>
                                                    </div>

                                                    <div class="dashboardsListMenuItemContent centerWithFlex col-xs-4">
                                                        <a id="exportAllOrgDashboardsButton" class="btn btn-warning btn-export-all-org-dashboards" href="../management/exportAllOrgDashboards.php" title="Export all dashboards for the selected organization">Export All Org Dash</a>
                                                    </div>
...
<?php if (!$_SESSION['isPublic']) : ?>
                ...
                {
                    case "show":
                        cardDiv = cardDiv + '<button type="button" class="dashBtnCard delegateDashBtnCard"><?php echo _("Manage"); ?></button>';
                        break;
                                        ...
                                        if (orgDel != "") {
                                            if (groupDel != null && groupDel != undefined) {
                                                if (groupDel != "" && groupDel != "All Groups") {
                                                    if (orgDel === "No Organization")
                                                        newDelegatedString = "cn=" + groupDel + ",<?= $ldapBaseDN ?>";
                                                    else
