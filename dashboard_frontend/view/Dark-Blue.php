...
<html lang="en">
    ...
    <link href="../css/themes/Dark-Blue/S4C-Dark-Blue-dashboard-view.css?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="../css/themes/Dark-Blue/style_widgets.css?v=<?php echo time();?>" type="text/css" />
...
*/
               ...
               else
               {
                ...
                for(var i = 0; i < dashboardWidgets.length; i++)
                {
                    ...
                    dashboardWidgets[i].hostFile = 'dark-blue';
...
-->
                <div class="toggle-container" style="display: none;">
					<button class="theme-btn light" onclick="setTheme('light')" title="Light mode">
						<!--sun icon--><span class="material-icons-round">light_mode</span>
					</button>
					<button class="theme-btn dark" onclick="setTheme('dark')" title="Dark mode">
						<!--moon icon--><span class="material-icons-round">brightness_4</span>
					</button>
  				</div>
    ...
    <div id="authFormDarkBackground" style="display: none;">
        <div class="row">
