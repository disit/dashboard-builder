...
<html lang="en">
    ...
    <link href="../css/themes/Gea-Orange/S4C-Gea-Orange-dashboard-view.css?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="../css/themes/Gea-Orange/style_widgets.css?v=<?php echo time();?>" type="text/css" />
...
*/
               ...
               else
               {
                ...
                for(var i = 0; i < dashboardWidgets.length; i++)
                {
                    ...
                    dashboardWidgets[i].hostFile = 'gea-orange';
