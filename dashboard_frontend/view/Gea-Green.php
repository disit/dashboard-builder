...
<html lang="en">
    ...
    <link href="../css/themes/Gea-Green/S4C-Gea-Green-dashboard-view.css?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="../css/themes/Gea-Green/style_widgets.css?v=<?php echo time();?>" type="text/css" />
...
*/
               ...
               else
               {
                ...
                for(var i = 0; i < dashboardWidgets.length; i++)
                {
                    ...
                    dashboardWidgets[i].hostFile = 'gea-green';
