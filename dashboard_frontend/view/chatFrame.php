...
session_start();
        ...
        function isPublic($idDash, $addMem) {
            ...
            if (isset($_SESSION['refreshToken'])) {
                ...
                //$service_url = "http://192.168.0.10:8080/datamanager/api/v1/username/ANONYMOUS/delegation/check?accessToken=".$accessToken."&sourceRequest=chatmanager&elementID=67";
