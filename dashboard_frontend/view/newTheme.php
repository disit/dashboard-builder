<?php 
   ...
   //     eventLog("Returned the following ERROR in newTheme.php for dashId = ".$dashId.": ".$dashId." is not an integer as expected. USER = " . $_SESSION['loggedUsername'] . ". Exit from script.");
   //     eventLog("Returned the following ERROR in newTheme.php for dashId = ".$dashId.": ".$dashId." is not an integer as expected. Exit from script.");
        eventLog("Returned the following ERROR in newTheme.php for dashId = ".$dashId.": ".$dashId." is not an integer as expected. Exit from script. HTTP REFERER: ".$_SERVER['HTTP_REFERER'] . "; Request URI: " . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . ". Request Method: " . $_SERVER['REQUEST_METHOD']);
        exit();
   };
    ...
    if($queryResult) 
    {
        ...
        else
        {
           ...
           if($queryResult->num_rows > 0) 
           {
                ...
                if($row['useBckImg'] == "yes" && $row['bckImgFilename'] != null){
                    $_SESSION[isBckImgPresent] = true;
                }else{
                    $_SESSION[isBckImgPresent] = false;
                }
           }
           else
           {
...
<html lang="en">
    ...
    <link href="../css/themes/newTheme/S4C-newTheme-dashboard-view.css?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="../css/themes/newTheme/style_widgets.css?v=<?php echo time();?>" type="text/css" />

    <!-- <?php echo $_SESSION[isBckImgPresent] ?> -->
    <?php if($_SESSION[isBckImgPresent]) echo "<style>:root { --bg-color: rgba(0, 0, 0, 0)}</style"?>
            ...
            function loadDashboard(dashboardParams, dashboardWidgets)
            {
               ...
               else
               {
                ...
                for(var i = 0; i < dashboardWidgets.length; i++)
                {
                    ...
                    dashboardWidgets[i].hostFile = 'newTheme';
    ...
    <div id="authFormDarkBackground">
        ...
        <div class="row">
            <div id="authFormContainer" class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4" style="padding-left: 0; padding-right: 0">
                <div class="col-xs-12" id="loginFormTitle" style="style="padding-left: 0; padding-right: 0"">
