...
<html lang="en">
    ...
    <link href="../css/themes/PA/S4C-PA-dashboard-view.css?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="../css/themes/PA/style_widgets.css?v=<?php echo time();?>" type="text/css" />
...
*/
               ...
               else
               {
                ...
                for(var i = 0; i < dashboardWidgets.length; i++)
                {
                    ...
                    dashboardWidgets[i].hostFile = 'pa';
                            ...
                            case 'author': case 'restrict':    
                                ...
                                switch(response.detail)
                                {
                                    ...
                                    default:
                                        ...
                                        $("#loginMainTitle").css("color", "white");
                                        ...
                                        $("#loginFormTitle").css("text-align", "center");
                                        $("#loginFormTitle").css("color", "white");
    ...
    function scrollFunction() {
      if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
        document.getElementById("header_main_PA").style.padding = "10px 50px";
      } else {
        document.getElementById("header_main_PA").style.padding = "50px";
      }
    }
    </script>
</head>
  ...
  <?php include "../cookie_banner/cookie-banner.php"; ?>
    ...
    <div id="dashboardViewMainContainer" class="container-fluid">
        ...
        <nav id="dashboardViewHeaderContainer" class="navbar navbar-fixed-top" role="navigation">
            ...
            <div id="header_main_PA" class="header_main">
              <div id="headerLogo">
              ...
              <?php include('snap4city-logo-PA.html');?>

              <div class="menu-btn click"><span class="material-icons"></span></div>
              </div>
