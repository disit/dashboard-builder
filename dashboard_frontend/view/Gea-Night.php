...
<html lang="en">
    ...
    <link href="../css/themes/Gea-Night/S4C-Gea-Night-dashboard-view.css?v=<?php echo time();?>" rel="stylesheet">
    <link rel="stylesheet" href="../css/themes/Gea-Night/style_widgets.css?v=<?php echo time();?>" type="text/css" />
